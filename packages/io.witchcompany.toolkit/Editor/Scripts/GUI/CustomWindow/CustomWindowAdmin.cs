...
// {
//     [Obsolete("Admin 기능은 더이상 사용하지 않습니다")]
...
//                     // 난이도
//                     using var check = new EditorGUI.ChangeCheckScope();
//                     var blockLevel = (GameLevel)EditorGUILayout.EnumPopup("level", AdminConfig.GameLevel);
//
//                     if (check.changed)
//                         AdminConfig.GameLevel = blockLevel;
//                 }
//                 
//                 // 블록 조회 상태
//                 using (var check = new EditorGUI.ChangeCheckScope())
...
//                 blockLevel = AdminConfig.BlockTheme != BlockTheme.Game ? null : AdminConfig.GameLevel.ToString().ToLower(),
...
//                         {
//                             key = keyGroup.key,
//                             type = keyGroup.alignment.ToString().ToLower(),
